...
# ==============================================================================
ALLOWED_PATHS='^(README\.md|LICENSE|\.gitignore|\.gitattributes|\.github/CODEOWNERS|\.github/[^/]+\.md|\.github/denylist\.example\.txt|\.github/workflows/[^/]+\.yml|\.githooks/pre-commit|scripts/[^/]+\.sh|assets/[^/]+\.(svg|png))$'
